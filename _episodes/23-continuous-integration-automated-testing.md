...
...
    ...
    strategy:
      matrix:
        ...
        python-version: ['3.8', '3.9', '3.10'] # The quotes are required because 3.10 is interpreted as 3.1 if it's not a string
